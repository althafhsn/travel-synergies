...
const ServicesCard = ({
  ...
  return (
    <Link
      href={href}
      className="relative bg-cover p-6 shadow-lg rounded-3xl text-center cursor-pointer lg:w-[350px] mx-auto lg:h-[250px] w-[250px] h-[150px] flex flex-col items-center justify-center overflow-hidden z-20 transform transition-transform duration-300 ease-in-out hover:scale-110 lg:hover:blur-0"
    >
      {/* Background Image and Blur */}
      <div
        className={`absolute inset-0 bg-cover lg:blur-sm transition-all duration-300 ease-in-out z-0 hover:blur-0 hover:scale-110 ${backgroundImage}`}
      ></div>
